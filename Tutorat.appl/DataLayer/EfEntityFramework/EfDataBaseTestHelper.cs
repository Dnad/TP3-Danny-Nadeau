...
namespace DataLayer.EfEntityFramework
{
    class EfDataBaseTestHelper
    {
        ...
        public void creationSeedTable()
        {
            ...
            TutoringSession tS1 = new TutoringSession() { DateTimeSession = new DateTime(2015, 03, 16), Time = 13,LengthSession = 2, HelpedStudentID = hS5.Id, TutorID = tutor5.Id };
            TutoringSession tS2 = new TutoringSession() { DateTimeSession = new DateTime(2015, 03, 24), Time = 10, LengthSession = 1, HelpedStudentID = hS5.Id, TutorID = tutor1.Id };
            TutoringSession tS3 = new TutoringSession() { DateTimeSession = new DateTime(2015, 03, 25), Time = 13, LengthSession = 1, HelpedStudentID = hS2.Id, TutorID = tutor4.Id };
            TutoringSession tS4 = new TutoringSession() { DateTimeSession = new DateTime(2015, 04, 01), Time = 12, LengthSession = 2, HelpedStudentID = hS1.Id, TutorID = tutor5.Id };
            TutoringSession tS5 = new TutoringSession() { DateTimeSession = new DateTime(2015, 04, 01), Time = 13, LengthSession = 1, HelpedStudentID = hS2.Id, TutorID = tutor3.Id };
            TutoringSession tS6 = new TutoringSession() { DateTimeSession = new DateTime(2015, 04, 06), Time = 16, LengthSession = 1, HelpedStudentID = hS1.Id, TutorID = tutor4.Id };
            TutoringSession tS7 = new TutoringSession() { DateTimeSession = new DateTime(2015, 04, 08), Time = 10, LengthSession = 1, HelpedStudentID = hS6.Id, TutorID = tutor4.Id };
            TutoringSession tS8 = new TutoringSession() { DateTimeSession = new DateTime(2015, 04, 10), Time = 10, LengthSession = 2, HelpedStudentID = hS1.Id, TutorID = tutor4.Id };
            TutoringSession tS9 = new TutoringSession() { DateTimeSession = new DateTime(2015, 04, 29), Time = 12, LengthSession = 1, HelpedStudentID = hS9.Id, TutorID = tutor5.Id };
            TutoringSession tS10 = new TutoringSession() { DateTimeSession = new DateTime(2015, 05, 25), Time = 13, LengthSession = 1, HelpedStudentID = hS10.Id, TutorID = tutor7.Id };
            TutoringSession tS11 = new TutoringSession() { DateTimeSession = new DateTime(2015, 05, 27), Time = 12, LengthSession = 2, HelpedStudentID = hS10.Id, TutorID = tutor5.Id };
            TutoringSession tS12 = new TutoringSession() { DateTimeSession = new DateTime(2015, 05, 27), Time = 13, LengthSession = 1, HelpedStudentID = hS2.Id, TutorID = tutor3.Id };
            TutoringSession tS13 = new TutoringSession() { DateTimeSession = new DateTime(2015, 06, 01), Time = 9, LengthSession = 1, HelpedStudentID = hS7.Id, TutorID = tutor7.Id };
            TutoringSession tS14 = new TutoringSession() { DateTimeSession = new DateTime(2015, 06, 02), Time = 9, LengthSession = 1, HelpedStudentID = hS11.Id, TutorID = tutor7.Id };
            TutoringSession tS15 = new TutoringSession() { DateTimeSession = new DateTime(2015, 06, 02), Time = 11, LengthSession = 1, HelpedStudentID = hS2.Id, TutorID = tutor7.Id };
            TutoringSession tS16 = new TutoringSession() { DateTimeSession = new DateTime(2015, 06, 02), Time = 13, LengthSession = 1, HelpedStudentID = hS5.Id, TutorID = tutor1.Id };
            TutoringSession tS17 = new TutoringSession() { DateTimeSession = new DateTime(2015, 06, 02), Time = 15, LengthSession = 1, HelpedStudentID = hS9.Id, TutorID = tutor4.Id };
            TutoringSession tS18 = new TutoringSession() { DateTimeSession = new DateTime(2015, 06, 03), Time = 13, LengthSession = 2, HelpedStudentID = hS7.Id, TutorID = tutor3.Id };
